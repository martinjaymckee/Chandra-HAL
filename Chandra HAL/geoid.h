...
public:
    ...
    constexpr static value_t e2() { return ((a2() - b2()) / a2()).value(); } //
    constexpr static value_t e2_prime() { return ((a2() - b2()) / b2()).value(); } //
    constexpr static value_t f() { return ((Derived::a() - Derived::b()) / Derived::a()).value(); }  // Flattening
