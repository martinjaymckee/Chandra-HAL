#ifndef CHANDRA_BMP390_H
#define CHANDRA_BMP390_H
...
struct BMP390ImplBase : BaseBarometricProxyImpl<Value, BaseUnits>
{
    ...
    BMP390ImplBase(const register_access_t& _regs, const scalar_t& _scale)
...
template<class Value, class BaseUnits, class Comm>
class BMP390PressureImpl : public BMP390ImplBase<Value, BaseUnits, Comm>
{
  public:
    using scalar_t = Value;
    using base_t = BMP390ImplBase<Value, BaseUnits, Comm>;
    using registers_t = typename base_t::registers_t;
    using register_access_t = chandra::drivers::RegisterDevice<Comm>;

    BMP390PressureImpl(const register_access_t& _regs)
      : base_t(_regs, 5.98e-4) {}
};

template<class Value, class BaseUnits, class Comm>
class BMP390TemperatureImpl : public BMP390ImplBase<Value, BaseUnits, Comm>
{
  public:
    using scalar_t = Value;
    using base_t = BMP390ImplBase<Value, BaseUnits, Comm>;
    ...
    BMP390TemperatureImpl(const register_access_t& _regs)
      : base_t(_regs, 5.98e-4) {}
};

template<class Value>
class BMP390CompensationValues
{
	public:
		BMP390CompensationValues() : valid_(false) {}
...
class BMP390
		: public Barometric<
		  	  BMP390<Value, Comm, PressureUnits, TemperatureUnits>,
			  Value,
			  PressureUnits, TemperatureUnits,
			  internal::BMP390PressureImpl<Value, PressureUnits, Comm>,
			  internal::BMP390TemperatureImpl<Value, TemperatureUnits, Comm>
		>
{
  protected:
    friend class Barometric<BMP390<Value, Comm, PressureUnits, TemperatureUnits>, Value, PressureUnits, TemperatureUnits, internal::BMP390PressureImpl<Value, PressureUnits, Comm>, internal::BMP390TemperatureImpl<Value, TemperatureUnits, Comm>>;
    using base_t = Barometric<BMP390<Value, Comm, PressureUnits, TemperatureUnits>, Value, PressureUnits, TemperatureUnits, internal::BMP390PressureImpl<Value, PressureUnits, Comm>, internal::BMP390TemperatureImpl<Value, TemperatureUnits, Comm>>;
    using scalar_t = typename base_t::scalar_t;
    using value_t = typename base_t::value_t;
    using ref_t = BMP390<Value, Comm, PressureUnits, TemperatureUnits>;
    using register_access_t = chandra::drivers::RegisterDevice<Comm>;
    ...
    using registers_t = typename internal::BMP390ImplBase<Value, PressureUnits, Comm>::registers_t;

  public:
    BMP390(register_access_t _regs)
    ...
    bool reset() {
    	...
    	// TODO: CHECK THAT THE BMP390 IS READY TO RECEIVE A COMMAND
...
//      Tselfheating_ = temperature_val_ - Tinit_;
  ...
  private:
    ...
    internal::BMP390CompensationValues<double> C; // Note: Currently the compensation only works with floating-point values
    scalar_t Tinit_ = 0;
