...
template<uint8_t Samples=32, bool Sampling=true, class Clock = chandra::chrono::timestamp_clock>
class ProfilingTimer
{
  ...
  private:
    bool insertSample(const duration_t& _duration) {
      samples_ << _duration;
